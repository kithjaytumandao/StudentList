...
namespace StudentList {
    ...
    public partial class ListDataSet : global::System.Data.DataSet {
        ...
        public partial class ListDataTable : global::System.Data.TypedTableBase<ListRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ListRow AddListRow(string FullName, string Email, string Address, string Phone, string Gender) {
...
namespace StudentList.ListDataSetTableAdapters {
    ...
    public partial class ListTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[List] ([Id], [FullName], [Email], [Address], [Phone], [Gender]" +
                ...
                "me, Email, Address, Phone, Gender FROM List WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[List] SET [Id] = @Id, [FullName] = @FullName, [Email] = @Email, [Address] = @Address, [Phone] = @Phone, [Gender] = @Gender WHERE (([Id] = @Original_Id) AND ((@IsNull_FullName = 1 AND [FullName] IS NULL) OR ([FullName] = @Original_FullName)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)));
SELECT Id, FullName, Email, Address, Phone, Gender FROM List WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FullName, Email, Address, Phone, Gender FROM dbo.List";
        ...
        public virtual int Delete(int Original_Id, string Original_FullName, string Original_Email, string Original_Address, string Original_Phone, string Original_Gender) {
        ...
        public virtual int Update(int Id, string FullName, string Email, string Address, string Phone, string Gender, int Original_Id, string Original_FullName, string Original_Email, string Original_Address, string Original_Phone, string Original_Gender) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FullName, string Email, string Address, string Phone, string Gender, int Original_Id, string Original_FullName, string Original_Email, string Original_Address, string Original_Phone, string Original_Gender) {
